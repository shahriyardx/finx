...
import { createWallet } from '@/db/repo';
import { useTheme } from '@/hooks/use-theme';
import { WALLET_COLORS, WALLET_ICONS } from '@/lib/categories';
    ...
    <ThemedView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <Pressable
          ...
          <ThemedText style={{ color: theme.onAccent, fontWeight: '700' }}>Save wallet</ThemedText>
        </Pressable>
      </ScrollView>
    </ThemedView>
  );
